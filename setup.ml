...
(* OASIS_START *)
(* DO NOT EDIT (digest: 39b851b97e3b5c504ff99976f0da3e0a) *)
(*
...
let setup_t =
  {
            ...
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$vult_tests", []))];
            ...
            [
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Error"; "Loc"; "PrintBuffer"; "Fitting"];
                      lib_pack = false;
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "vultjs.ml"});
               Executable
                 ({
                     cs_name = "vultdebug";
                     cs_data = PropList.Data.create ();
     ...
     oasis_version = "0.4.8";
     oasis_digest = Some "[\026\011\137\192#\178\1539\177r\211t(m\190";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
