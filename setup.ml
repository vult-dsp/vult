...
(* OASIS_START *)
(* DO NOT EDIT (digest: 207cb2ca952d1d92ae6abdc8c9e7bf1f) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules =
                        ["Mapper"; "PrintTypes"; "TypesVult"; "Env"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = None;
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_path = "src/parser";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "vult_core"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_path = ".";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "vult"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\021r\151!´-\156t~Nô\029\141\127\029Æ";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
